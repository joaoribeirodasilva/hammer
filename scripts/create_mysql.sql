...
--
-- Host: 192.168.0.205    Database: KafkaReplication
-- ------------------------------------------------------
...
CREATE TABLE `users` (
  ...
  `changed_date` varchar(100) NOT NULL DEFAULT current_timestamp(),
  PRIMARY KEY (`id`)
...
--
-- Dumping routines for database 'KafkaReplication'
--
...
-- Dump completed on 2024-03-20 18:04:34
